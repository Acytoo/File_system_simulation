...
//char pathAbs[100][14];					/*current folder stack, initial all this space to 0 at the beginning*/
...
//        if (users.userName[i] == strUserName) {
...
//                    strcat(userName, "@Acytxx: ");
//                    strcat(userName, "#");    //root user: #
//                }
//                else {
//                    strcat(userName, users.userName[i]);
//                    strcat(userName, "@Acytxx: ");
//                    strcat(userName, "$");    //none root user: $
//                }
...
//    //Read inode bitmap
//    fseek(virtualDisk, 2 * BLOCK_SIZE, SEEK_SET);
//    fread(inode_bitmap, sizeof(unsigned short) * INODE_NUM, 1, virtualDisk);
...
//*			some error occur.
//*/
//int vim(inode& ifile, const char* content)
//{
//    //parameter check
//    if (content == NULL)
//    {
...
//    else {
//        for (int i = 0; i < 14; i++) {
//            pathAbs[dir_pointer][i] = dirname[i];
//        }
//        dir_pointer++;
//    }
//    return true;
...
//            //Write
//            fseek(virtualDisk, DATA_START + BLOCK_SIZE, SEEK_SET);
//            fwrite(&users, sizeof(users), 1, virtualDisk);
//            printf("Success\n");
//        }
//    }
//    else {
...
//        }
//        //Open file
//        else if (strcmp("op", para1) == 0) {
//            flag = true;
//            scanf("%s", para2);
//            para2[1023] = 0;	//security protection

//            currentInode = op(para2);
//        }
//        //Write file
//        else if (strcmp("vim", para1) == 0 && flag) {
//            scanf("%s", para2);
//            para2[1023] = 0;	//security protection
...
////    FILE* fs_test = fopen("virtualDisk.yt", "r");
////    if (fs_test == NULL)
////    {
...
////    }
////    simulationStart();
////    pathAbs[dir_pointer][0] = 'r'; pathAbs[dir_pointer][1] = 'o'; pathAbs[dir_pointer][2] = 'o'; pathAbs[dir_pointer][3] = 't'; pathAbs[dir_pointer][4] = '\0';
////    dir_pointer++;
////    //First log in
////    while (!login());
////    //User's mode of file system
